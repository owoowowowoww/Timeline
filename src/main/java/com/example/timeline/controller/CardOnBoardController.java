...
public class CardOnBoardController {
    ...
    public CardOnBoardController(Card aCard, JouerController controllerMainScreen) {
    ...
    public void selectActionDescription() {
        mainController.setCardSelectedBoard(controlledCard);
    }
